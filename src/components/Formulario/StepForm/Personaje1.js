...
export default function Personaje1({ arduino, navigation }) {
  ...
  useEffect(() => {
    const setTarjeta = async () => {
      try {
        await fetch("http://localhost:8080/personaje1", { method: "POST" });
      } catch (error) {
  ...
  return (
    <>
      ...
      <div className="Form-Container">
        <h3 className="font-weight-bold main-title mt-3 mb-3">Selecci&oacute;n del personaje 1</h3>
        <div className="form">
